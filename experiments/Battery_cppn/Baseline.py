...
##Base file taken from Karine' experiments hyperplasticodingp.py
#Objective function uses only displacement_velocity
async def run():
    """
    ...
    def fitness_function_plane(measures, robot):
        return fitness.displacement_velocity(measures, robot)
    ...
    population_conf = PopulationConfig(
        ...
        selection=lambda individuals: tournament_selection(individuals, environments, 4),
        parent_selection=lambda individuals: multiple_selection(individuals, 4, tournament_selection, environments),
